...
Working on the [**Bankin**](http://bankin.com/) and [**Bridge**](http://bridgeapi.io/) projects 🔭 . And exploring decentralized trust concepts with [**Open Market**](https://github.com/jterrazz/app.open-mt) 🌱
