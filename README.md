...
<br>**[ETH Paris Hackathon](https://github.com/jterrazz/hackathons.ethparis-collective)** → Blockchain crowdfunding platform

## Systems

**[Expert System](https://github.com/jterrazz/42-expert-system)** → Backward chaining rule-based inference
<br>**[Malloc](https://github.com/jterrazz/42-malloc)** → Dynamic memory allocator with mmap
<br>**[Binary Analysis](https://github.com/jterrazz/42-nm-otool)** → Mach-O parsing for nm and otool
<br>**[Security](https://github.com/jterrazz/42-override)** → Binary exploitation and reverse engineering
<br>**[Cryptography](https://github.com/jterrazz/42-ssl-md5)** → MD5, SHA-256 and hash algorithms
<br>[...](https://github.com/jterrazz?tab=repositories&q=42&type=&language=&sort=)
