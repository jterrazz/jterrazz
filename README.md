...
Working on the [**Bankin**](http://bankin.com/) and [**Bridge**](http://bridgeapi.io/) projects 🔭 . And exploring decentralized trust concepts with [**Open.MT - Open Market**](https://github.com/jterrazz/app.open-mt) 🌱

### My work

**📗 Blog** - [medium](http://blog.jterrazz.com)
</br>
**📘 Open.MT** - [wiki](https://github.com/jterrazz/app.open-mt) - [open-mt-api](https://github.com/jterrazz/app.open-mt-api) - [open-mt-client](https://github.com/jterrazz/app.open-mt-client) - [open-mt-landing](https://github.com/jterrazz/app.open-mt-landing) - [open-mt-tool-queue-dashboard](https://github.com/jterrazz/app.open-mt-tool-queue-dashboard)
</br>
